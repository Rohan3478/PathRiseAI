...
import { Download, Edit, Monitor, Save, Sparkles } from 'lucide-react'
...
const ResumeBuilder = ({ initialContent }) => {
  ...
  const handleImproveSummary = async () => {
    ...
    try {
      ...
      const improvedSummary = await improveWithAI(currentSummary)
      if (improvedSummary) {
        setValue("summary", improvedSummary) // This will properly update the form state
